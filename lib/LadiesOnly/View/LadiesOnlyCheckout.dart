...
import 'LadiesOnlyCheckoutReciept.dart';

class CheckOutData {
  final dynamic venueList;
  final dynamic selectedFieldData;
  ...
  CheckOutData(
      ...
      required this.selectedFieldData,
...
class LadiesOnlyCheckout extends StatelessWidget {
  LadiesOnlyCheckout({Key? key, required this.checkOutData}) : super(key: key);
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image:
                                  NetworkImage(checkOutData.venueList["image"]),
                              fit: BoxFit.cover),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(checkOutData.venueList["venuename"],
                              ...
                              Row(
                                ...
                                children: [
                                  NormalFont(
                                      text: checkOutData
                                          .selectedFieldData["sportsname"]),
                                  NormalBoldFont(
                                      text: checkOutData.amount.toString())
                                ],
                              ),
                              Row(
                                mainAxisAlignment:
            ...
            children: [
              Text('Date',
                  style: GoogleFonts.titilliumWeb(
                      ...
                      height: .25.h)),
              Text(
                  "${checkOutData.selectedDate.day}-${checkOutData.selectedDate.month}-${checkOutData.selectedDate.year}",
                  style: GoogleFonts.titilliumWeb(
                    fontSize: 10.sp,
                    color: Colors.black,
                    fontWeight: FontWeight.w700,
            ...
            children: [
              Text('Time',
                  style: GoogleFonts.titilliumWeb(
                      ...
                      height: .25.h)),
              Text(
                  '${checkOutData.selection.first} to ${checkOutData.selection.last}',
                  style: GoogleFonts.titilliumWeb(
                    fontSize: 10.sp,
                    color: Colors.black,
                    fontWeight: FontWeight.w700,
            ...
            children: [
              Text('Field',
                  style: GoogleFonts.titilliumWeb(
                      ...
                      fontWeight: FontWeight.w500,
                      height: .25.h)),
              Text(checkOutData.selectedFieldData["sportsname"],
                  style: GoogleFonts.titilliumWeb(
                    fontSize: 10.sp,
                    color: Colors.black,
                    fontWeight: FontWeight.w700,
            ...
            child: Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  contentPadding:
                      new EdgeInsets.symmetric(vertical: 0.0, horizontal: 1.h),
