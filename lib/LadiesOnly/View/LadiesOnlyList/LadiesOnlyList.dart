...
import 'IndoorLadies.dart';
import 'OutdoorLadies.dart';

class GeneralShowcaseList extends StatelessWidget {
  const GeneralShowcaseList({Key? key, required this.homePageCategory})
      : super(key: key);
  final HomePageCategories homePageCategory;
                      ...
                      child: Column(children: [
                        ...
                        Container(
                          ...
                          child: TabBar(
                              ...
                              labelColor: const Color(0xff035B59),
