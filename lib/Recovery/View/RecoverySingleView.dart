...
import 'RecoveryCheckout.dart';


class RecoverySingleView extends StatefulWidget {
  RecoverySingleView({Key? key}) : super(key: key);

  @override
  State<RecoverySingleView> createState() => _RecoverySingleViewState();
}

class _RecoverySingleViewState extends State<RecoverySingleView> {
                          ...
                          child: Column(
                            children: [
                              Container(
                                  ...
                                  child: Image(
                                      image: AssetImage(
                                          "Assets/LadiesOnlyIcons/Hotbath.png"))),
                              Padding(
                                padding: EdgeInsets.only(top: .3.h),
                                child: SmallGreyColor(text: 'Hot bath'),
                              )
                            ],
                          ),
                        )),
                          ...
                          child: Column(
                            children: [
                              Container(
                                  ...
                                  child: Image(
                                      image: AssetImage(
                                          "Assets/LadiesOnlyIcons/Stretching.png"))),
                              Padding(
                                padding: EdgeInsets.only(top: .3.h),
                                child: SmallGreyColor(text: 'Stretching'),
                              )
                            ],
                          ),
                        )),
                          ...
                          child: Column(
                            children: [
                              Container(
                                  ...
                                  child: Image(
                                      image: AssetImage(
                                          "Assets/LadiesOnlyIcons/meditation.png"))),
                              Padding(
                                padding: EdgeInsets.only(top: .3.h),
                                child: SmallGreyColor(text: 'Meditation'),
                              )
                            ],
                          ),
                        )),
