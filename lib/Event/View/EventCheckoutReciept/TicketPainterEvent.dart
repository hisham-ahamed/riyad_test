...
class TicketPainterEvent extends CustomPainter {
  ...
  TicketPainterEvent({required this.bgColor, required this.borderColor});
  ...
  @override
  bool shouldRepaint(TicketPainterEvent oldDelegate) => false;

  @override
  bool shouldRebuildSemantics(TicketPainterEvent oldDelegate) => false;
}
